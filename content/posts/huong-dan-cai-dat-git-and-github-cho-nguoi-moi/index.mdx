---
title: Hướng dẫn cài đặt Git & GitHub cho người mới
description: Hướng dẫn Git từ cơ bản đến nâng cao, giúp bạn hiểu cách quản lý phiên bản, commit, branch, merge và làm việc nhóm hiệu quả.
date: 2025-01-01
slug: huong-dan-cai-dat-git-and-github-cho-nguoi-moi
tags:
  - Git
---
...
![Kiểm tra version](./kiem_tra_version_git.png)
...
![Tạo kho lưu trữ remote](./tao_kho_luu_tru_remote.png)
...
![Khởi tạo local repo](./khoi_tao_local_repo.png)
...
![Full các bước](./toan_bo_quy_trinh_su_dung_git.png)
